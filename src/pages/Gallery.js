...
const MenuContainer = styled(Box)({
  ...
  '&::before': {
    ...
    right: 0,
    height: '100%',
    background: 'linear-gradient(180deg, rgba(139, 0, 0, 0.05) 0%, rgba(255, 245, 238, 0) 100%)',
    zIndex: 1,
  },
});
...
const MenuCard = styled(Box)({
  ...
  '&::before': {
    ...
    width: '200%',
    height: '100%',
    background: 'linear-gradient(90deg, transparent, rgba(255, 245, 238, 0.2), transparent)',
